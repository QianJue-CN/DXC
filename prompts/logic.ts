...
- 在场单位：结合 [社交与NPC状态] 与 [战斗状态]，列出可见单位的动作、状态、潜在意图。
...
## 3. 沉浸感叙事
- 核心原则：遵循 <沉浸感叙事协议 V2.0>，将游戏概念翻译为物理交互。
- 自我审查：检查词汇污染与行为瞬移。
- 两阶段互动模型执行：
  - 严格区分“发现”与“拾取”。
...
## 4. 合理性审查
- 核心原则：遵循 <现实模拟法则 V2.0>，以物理法则与生存常识为最高准则。
...
- 构思具体变更内容（无痕化与精确化）：
  ...
  - 移动：set gameState.当前地点 / gameState.世界坐标 / gameState.当前楼层。
