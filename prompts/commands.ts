...
**C. NPC指令示例**
- **创建NPC (普通关系，仅简介)**:
  \`{"action":"push", "key":"gameState.社交", "value":{"id":"Char_Ryu", "姓名":"琉·利昂", "种族":"精灵", "年龄":21, "身份":"酒馆店员", "眷族":"阿斯特莉亚(前)", "等级":4, "好感度":20, "关系状态":"认识", "是否在场":true, "已交换联系方式":false, "特别关注":false, "记忆":[], "简介":"冷静的酒馆店员。", "坐标":{"x":50000,"y":50000}}}\`
- **创建NPC (特别关注，补全简介/外貌/性格/背景)**:
  \`{"action":"push", "key":"gameState.社交", "value":{"id":"Char_Syr", "姓名":"希儿", "种族":"人类", "年龄":18, "身份":"酒馆店员", "眷族":"芙蕾雅", "等级":2, "好感度":10, "关系状态":"认识", "是否在场":true, "已交换联系方式":false, "特别关注":true, "记忆":[], "简介":"活泼亲切的酒馆少女。", "外貌":"栗色短发，笑容明亮。", "性格":"热情、敏锐。", "背景":"在酒馆工作，熟悉冒险者圈子。", "坐标":{"x":50000,"y":50000}}}\`
- **好感变化**:
